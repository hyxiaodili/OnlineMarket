...
(function($, window) {
    ...
    publicMethod.position = function(speed, loadedCallback) {
		...
		maxWidth = isIE6 == true?$window.width():$window.width() > $("body").width() ? $("body").width() : $window.width(),
		posLeft = Math.max(maxWidth - settings.w - loadedWidth - interfaceWidth, 0) / 2 + $window.scrollLeft();

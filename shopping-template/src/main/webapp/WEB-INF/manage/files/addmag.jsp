			...
			<TD width="100%">
				...
				<legend>管理员信息</legend>
					  ...
					  <tr>
					    ...
					    <td><span class="red">
                          <input name="txt34222" type="text" class="text" style="width:154px" value="" />
					      *</span></td>
						...
						<tr>
							...
							<td >
								...
								<select>
									<option name="male" value="">男
									<option name="female" value="">女
								</select>
							</td>
					   ...
					   <td bgcolor="#FFFFFF">
					<input type="checkbox"  name ="act" value=""/>添加

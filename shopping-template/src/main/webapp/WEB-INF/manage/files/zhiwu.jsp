		...
		<TR>
			<TD width="100%">
				...
				<legend>广告信息</legend>
					  ...
					  <tr>
					    <td nowrap align="right" width="11%">广告标题:</td>
					    <td width="27%"><input name='txt3' type="password" class="text" style="width:154px" value="" />
				        <span class="red">*</span></td>
					    </tr>
					  <tr>
					    <td width="11%" align="right" nowrap>上传图片:</td>
					    <td colspan="2"> <input type="file" name="pricute" size=30><input type="button" value="上传" onclick=""/></td>
					   </tr>
						<tr>
							...
							<td>
								<select>
									<option name="0" value/>轮播广告
									<option name="1" value/>页面右侧
									<option name="2" value/>页面中部

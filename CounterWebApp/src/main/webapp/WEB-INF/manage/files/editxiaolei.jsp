		...
		<TR>
			<TD width="100%">
				...
				<legend></legend>
					  ...
					  <tr>
					    <td nowrap align="right">小类名称:</td>
					    <td><input name="" id="" class="text" style="width:154px" value="厨房用具" /></td>
					  </tr>
					   <tr>
					    <td nowrap align="right">所属大类:</td>
					    <td><input name="" id="" class="text" style="width:154px" value="家居" /></td>
					  </tr>
					</table>
					<br />
				</fieldset>			

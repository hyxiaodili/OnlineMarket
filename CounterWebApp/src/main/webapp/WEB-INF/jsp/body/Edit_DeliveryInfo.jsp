...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="addadr">
						...
						<dl>
							...
							<dt >详细地址：</dt>
							<dd>
							<input type="text" class="input adr"  name="Address" id="Address"  value="" />*300个城市送货上门.</dd>
							<dt>
							  邮政编码：</dt>
							<dd>
							...
							<dt>固定电话：</dt>
							<dd>
						  <input type="text" name="Tel" id="Tel" value=""  class="input" />*请填写区号<span id="PhoneCode" style="color:#ff0000; padding:2px;"></span> </dd>
							<dt>手机：</dt>
							<dd>
						  <input type="text" name="Mobile" value="" class="input" />*手机和固定电话至少有一项必填</dd>
						</dl>
						<p class="btns">

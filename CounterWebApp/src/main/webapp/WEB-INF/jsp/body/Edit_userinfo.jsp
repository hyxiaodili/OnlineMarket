...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="ctl00_Head1">
		...
		<script type="text/javascript">
			...
			function show()
			{
				if (document.getElementById('OtherAddr').checked == true)
				{
				
					$("#Address").css('display','block'); 
				}else if (document.getElementById('OtherAddr').checked == false)
				{
    ...
    <body id="body" class="cols_manage">
                    ...
                    <div id="main">
                        <div id="mdfdata" class="mngbox">
                            <div class="main">
                                ...
                                <p class="tips">
                                    帮助我们完善您的个人信息，有助于我们未来根据您的情况提供更加个性化的服务；奋斗商城会对您的个人资料隐私加以保密。
                                </p>
                                <form method="post" id="myform" onsubmit="return Check_User_Login();">
                                    <input type="hidden" name="Change_User_Info" value="true" />
                                    <dl>
                                        <dt>
                                            <span class="star">
                                                *
                                        ...
                                        <dd>
                                            <input type="text" maxlength="50" name="TrueName" id="TrueName" class="input"
                                            value="" onblur="CheckOnBlur(this.id)" />
                                            <div id="WrongTrueName" style=" display:none" class="WrongText">
                                                请填写您的姓名
                                            </div>
                                        </dd>
                                        <dt>
                                        ...
                                        <dd>
                                            <input id="NewUserName" type="text" maxlength="16" name="NewUserName"
                                            class="input" value="dahai" onblur="CheckOnBlur(this.id)" />
                                            <div id="WrongNewUserName" style=" display:none" class="WrongText">
                                                昵称为中英文、数字、下划线
                                            </div>
                                        </dd>
                                        <dt>
                                        ...
                                        <dd>
                                            <input type="text" name="Email" maxlength="50" id="Email" class="input"
                                            value="whj1028@126.com" onblur="CheckOnBlur(this.id)" />
                                            <div id="WrongEmail" style=" display:none" class="WrongText">
                                                Email格式错误
                                            </div>
                                        </dd>
                                        <dt>
                                        ...
                                        <dd>
                                            <input type="text" name="Mobile" id="Mobile" class="input" maxlength="11"
                                            value="" onblur="CheckOnBlur(this.id)" />
                                            <div id="WrongMobile" style=" display:none" class="WrongText">
                                                手机格式错误
                                            </div>
                                        </dd>
										<dt>
                                        ...
                                        <dd>
                                            <select>
												<option name="" value="">黑龙江
											</select>
											<span>省</span>
											<select>
												<option name="" value="">哈尔滨
											</select>
											<span>市</span>
											<select>
												<option name="" value="">呼兰
											</select>
											<span>区</span>
                                        </dd>
										<dt>
                                        ...
                                        <dd>
                                            <input type="text" name="PostalCode" maxlength="6" id="PostalCode" class="input"
                                            value="" onblur="CheckOnBlur(this.id)" />
                                            <div id="WrongPostalCode" style=" display:none" class="WrongText">
                                                邮政编码必须是6位数字
                                            </div>
                                            <br />
                                            <span id="SetPostalCode" style="color:#ff0000; padding:2px;">
                                            </span>
                                        </dd>
                                        <dt>
                                            <span class="star">
                                        ...
                                        <dd>
                                            ...
                                            <input type="radio" name="AddressType" onclick="Address.style.display='none'"
                                            value="addr1" />
                                            <label class="black">
                                                黑龙江省哈尔滨市呼兰区学院路长青大街111号
                                            </label><br>
                                            <input type="radio" name="AddressType" onclick="Address.style.display='none'"
                                            value="addr2" />
                                            <label class="black">
                                            ...
                                            <input type="radio" name="AddressType" id="OtherAddr" onclick="show();"
                                            value="其他"/>
                                            <label class="black">
                                                其他
                                            </label>
                                        ...
                                        <dd>
                                            <input type="text" name="Address" id="Address" class="input" style="width:280px;display:none"
                                            value="输入新的配送地址" onblur="CheckOnBlur(this.id)" />
                                            <div id="WrongAddress" style=" display:none" class="WrongText">
                                                请填写您的详细地址
                                            </div>
                                        </dd>
                                        
                                    </dl>
                                    <p class="btns" style="padding-top:20px;" align="left">
        ...
        <script type="text/javascript">
            ...
            function ToggleDetail() {
                var detailControlObj = document.getElementById("checkDetail") var detailObj = document.getElementById("detailInfo");
            ...
            function SetCheckBox() {
                var formFavorateColor = document.getElementById("FavorateColor") var OftenClothesCategory = document.getElementById("OftenClothesCategory") var array = document.getElementsByTagName("input") for (i = 0; i < array.length; i++) {
            ...
            function ChangeVocation() {
                ...
                var vocationObj = document.getElementById("Vocation") var industyT = document.getElementById('industryTitle') var industryC = document.getElementById('industryContent') industrySelect = document.getElementById("Industry") if (vocationObj.value == "军人" || vocationObj.value == "学生" || vocationObj.value == "退休/无业人员" || vocationObj.value == "家庭主妇" || vocationObj.value == "其他") {
            ...
            function ChangeMarriageStatus() {
                marriageObj = document.getElementById("MarriageStatus") var childT = document.getElementById("childbirthdayTitle") var childC = document.getElementById('childbirthdayContent') if (marriageObj.value == "已婚且有子女") {
                    childT.style.display = "block"childC.style.display = "block"
                } else {
                    document.getElementById("cYear").value = "";
                    document.getElementById("cMonth").value = "";
                    document.getElementById("cDay").value = "";
                    childT.style.display = "none"childC.style.display = "none"
                }
            }
            ...
            function CheckOnBlur(f_v) {
                var ele = document.getElementById(f_v) if (f_v == "TrueName") {
            ...
            function Check_User_Login() {
                ...
                var focusTitle = "";
                var canSubmit = true;
                var form_truename = document.getElementById("TrueName") var form_email = document.getElementById("Email") var form_province = document.getElementById("Province") var form_city = document.getElementById("City") var form_area = document.getElementById("Area") var form_address = document.getElementById("Address") var form_addresstype = document.getElementById("AddressType") var form_postalcode = document.getElementById("PostalCode") var form_newusername = document.getElementById("NewUserName") var form_mobile = document.getElementById("Mobile") var form_b_y = document.getElementById("bYear") var form_b_m = document.getElementById("bMonth") var form_b_d = document.getElementById("bDay");

                var form_c_y = document.getElementById("cYear") var form_c_m = document.getElementById("cMonth") var form_c_d = document.getElementById("cDay")

                if (form_truename.value == '' || form_truename.value.length < 2) {
                    showElement("WrongTrueName") focusTitle = SetFocusTitle(focusTitle, "WrongTrueName") canSubmit = false;
                } else {
                    hideElement("WrongTrueName")
                }
                ...
                if (!/^[\w-]+(\.[\w-]+)*@[\w-]+(\.(\w)+)*(\.(\w){2,3})$/.test(form_email.value)) {
                    showElement("WrongEmail");
                    focusTitle = SetFocusTitle(focusTitle, "WrongEmail") canSubmit = false;
                } else {
                    hideElement("WrongEmail")
                }
                ...
                if (form_province.value == "" || form_city.value == "" || form_area.value == "") {
                    ...
                    focusTitle = SetFocusTitle(focusTitle, "WrongLivingCity") canSubmit = false;
                } else {
                ...
                if (form_address.value == '' || form_address.value.length < 2) {
                    showElement("WrongAddress");
                    focusTitle = SetFocusTitle(focusTitle, "WrongAddress") canSubmit = false;
                } else {
                    hideElement("WrongAddress");
                }
                if (!/^(\d){6}$/.test(form_postalcode.value)) {
                    showElement("WrongPostalCode") focusTitle = SetFocusTitle(focusTitle, "WrongPostalCode") canSubmit = false;
                } else {
                    hideElement("WrongPostalCode")
                }

                if (form_newusername.value != "" && !(/^[a-zA-Z0-9_\u4e00-\u9fa5]+$/.test(form_newusername.value))) {
                    showElement("WrongNewUserName") focusTitle = SetFocusTitle(focusTitle, "WrongNewUserName") canSubmit = false;
                } else {
                    hideElement("WrongNewUserName")
                }

                if (!/^((13|15|18|14)+\d{9})$/.test(form_mobile.value)) {
                    showElement("WrongMobile") focusTitle = SetFocusTitle(focusTitle, "WrongMobile") canSubmit = false
                } else {
                    hideElement("WrongMobile")
                }
                ...
                if (form_c_y.value != "" || form_c_m.value != "" || form_c_d.value != "") {
                    if (form_c_y.value == "" || form_c_m.value == "" || form_c_d.value == "") {
                        showElement("WrongChildBirthDay") focusTitle = SetFocusTitle(focusTitle, "WrongChildBirthDay") canSubmit = false;
                    } else {

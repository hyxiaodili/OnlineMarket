        ...
        <div id="wrap">
            <div id="Div1">
                <div id="body">
                    ...
                    <!--User_Interface End-->
                    <div id="main">
					<div id="address" class="mngbox">
					<div class="main">
					<span id="ctl00_ContentPlaceHolder1_Label_AddressList"><h3><span>我的收货地址簿</span></h3><ol><li>收货人：whj——fendou<br/><p>收货地址：哈尔滨市呼兰区学院路长青大街111号</p><p>邮政编码：150050</p><p>电话：0451-51997288</p><p>手机：1320000000</p><p class="operate"><input type='button'  value='修改'class="btn bay"   onclick="javascript:EditAddress('7375959');">&nbsp;&nbsp;&nbsp;&nbsp;<input type='button' value='删除' class="btn bay"   onclick="if(confirm('确实要删除该地址吗?')){DeleteAddress('7375959');}"></p></li></ol></span>
					

					
	<script language="javascript" src="PublicControls/Js/StringTrim.js"></script>
	<script language="javascript" src="PublicControls/Js/ConsigneeCheck.js"></script>
	<script language="javascript" src="PublicControls/Js/EmailCheck.js"></script>
	<script language="javascript" src="PublicControls/Js/Area.js"></script>
	<form name="Form_Consignee" id="Form_Consignee" method="post" action="" onsubmit="return Check_Consignee(this);">
	<div class="addadr">
						<h3><span>输入新的收货地址</span></h3>
						<dl>
							<dt>收货人姓名：</dt>
							<dd>
								<input type="text" name="Name" class="input" value="whj——fendou" />
							</dd>
							<dt >详细地址：</dt>
							<dd>
							<input type="text" class="input adr"  name="Address" id="Address"  value="哈尔滨市呼兰区学院路长青大街111号" />*300个城市送货上门.</dd>
							<dt>
							  邮政编码：</dt>
							<dd>
							  
							  <input type="text" name="Zip" id="Zip" value="150050" class="input" />
							  <br />
							  <span id="SetPostalCode" style="color:#ff0000; padding:2px;"></span></dd>
							<dt>固定电话：</dt>
							<dd>
						  <input type="text" name="Tel" id="Tel" value="0451-51997288"  class="input" />*请填写区号<span id="PhoneCode" style="color:#ff0000; padding:2px;"></span> </dd>
							<dt>手机：</dt>
							<dd>
						  <input type="text" name="Mobile" value="1320000000" class="input" />*手机和固定电话至少有一项必填</dd>
						</dl>
						<p class="btns">
							<input type="submit" class="btn" value="配送" style="cursor:pointer;"/>
						</p>
					</div>
...
{
location.href="Edit_DeliveryInfo.aspx?OperID="+ID+"&OperType=Action";			
}
function EditAddress(ID)
{
location.href="Edit_addr.html";			
}
function DeleteAddress(ID)
{
location.href="Edit_DeliveryInfo.aspx?OperID="+ID+"&OperType=Delete";			
}
document.getElementById("User_TransferWay").className = "current";//控制CSS
document.getElementById("UserMap").innerHTML = "修改送货信息";//控制CSS
</script>

            ...
            <div class="dingdan">
                <div id="OrderDiv" class="bxSty" style="margin-bottom:15px;" align="center">
                    ...
                    <div class="nowPayArea">
                        <p id="OrderWord">
                            ...
                            立刻进行网上支付。支付完毕后，立刻安排将您的货物发出，如您需要稍后支付，您可以24小时之内到“我的账
                            <br />
                            户”中完成支付，网上支付的订单将保留
                            <strong>
                                24小时
                ...
                <div id="EndWord" style="text-align:left;line-height:18px;">
                    <p>
                        ...
                        中查看或取消您的订单，由于系统需要对订单进行预处理，你可能不能立即查询到刚提交的订单
                        <br />
                        感谢您的订购！如您对网站购物过程有任何意见或建议请告诉我们。
                        <a href="#">
                            意见反馈>>
                        </a>
                    </p>
                    ...
                    success: function(res) {
                        ...
                        if (isSuccess == "Success") {
                            $(res).find("ProductItem").each(function(i) {
                                ...
                                $("#rProDiv_pg_" + i).empty().append("<a href='" + poductInfoUrl + "'target='_blank' >" + productName + "</a>"); //商品名称
                                $("#rProDiv_href_" + i).attr("href", poductInfoUrl); //链接
                                $("#rProDiv_img_" + i).attr("src", productPotoUrl); //图片
                                $("#rProDiv_mp_" + i).html("市场价￥" + productMarketPrice);
                                $("#rProDiv_sp_" + i).html("售价￥" + productSellPrice);
                            });

...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="ctl00_Head1">
        ...
        <meta name="keywords" content="简约生活牛仔风衬衫, 服装,直销,衬衣,衬衫,牛津纺,经纬80公里全棉衬衫,领带,毛背心,卡其裤"
        />
        <meta name="description" content="简约生活牛仔风衬衫,是产品之一，VANCL是专业生产和销售男装的品牌，包括正装衬衣、休闲衬衣、短袖衬衣、全棉免烫牛津纺衬衫、经纬80公里全棉衬衫、领带、毛背心、卡其裤。"
        />
        ...
        />
        <link href="css/danpinWindows.css" type="text/css" rel="stylesheet" charset="utf-8"
        />
        ...
        <script type="text/javascript" src="js/jquery.lazyload.js?v=1.1"
        defer="defer">
        </script>
        ...
        <script type="text/javascript" src="js/styledetail.js" defer="defer">
        </script>
        <script type="text/javascript" src="js/ct.js" defer="defer">
        </script>
        <script type="text/javascript" src="js/sliderClass.js"
        defer="defer">
        </script>
    </head>
       ...
       <div id="Head">
        ...
        <div class="danpinBox">
            ...
            <div class="breadNav">
                ...
                <a href="search_k.html" title="女装">
                    女装
                </a>
                <span>
                    &gt;
                </span>
                <a href="search_k.html" title="衬衫">
                    衬衫
                </a>
                <span>
                    &gt;
                </span>
                <a href="search_k.html" title="长袖衬衫">
                    长袖衬衫
                </a>
                <span>
                    &gt;
                </span>
                <a href="search_k.html" title="长款衬衫">
                    长款衬衫
                </a>
                <span>
                    &gt;
                </span>
                <span id="styleinfo" name="4819">
                    简约生活牛仔风衬衫
                </span>
            </div>
            <!-- E 面包屑导航 -->
            ...
            <div class="danpinArea">
              ...
              <div class="danpinLeft">
                    <div class="selImg">
                        <div class="smallImg">
                            <div class="smallImgUp">
                                <img src="images/small/smallImgUp02.gif" alt=""
                                title="">
                            </div>
                            <ul id="imageMenu">
                                <li id="onlickImg" name="Windows-track-0" class="track">
                                    <img src="images/small/0015137-1201101171649588073.jpg"
                                    alt="简约生活牛仔风衬衫 牛仔色" />
                                </li>
                                <li name="Windows-track-1" class="track">
                                    <img src="images/small/0015137-7201101171649588073.jpg"
                                    alt="简约生活牛仔风衬衫 牛仔色" />
                                </li>
                                <li name="Windows-track-2" class="track">
                                    <img src="images/small/0015137-8201101171649588073.jpg"
                                    alt="简约生活牛仔风衬衫 牛仔色" />
                                </li>
                                <li name="Windows-track-3" class="track">
                                    <img src="images/small/0015137-5201011261502100360.jpg"
                                    alt="简约生活牛仔风衬衫 牛仔色" />
                                </li>
                                <li name="Windows-track-4" class="track">
                                    <img src="images/small/2010_10_13_10_13_42_6743.jpg"
                                    alt="简约生活牛仔风衬衫 牛仔色" />
                                </li>
                                <li name="Windows-track-5" class="track">
                                    <img src="images/small/2010_10_13_10_15_3_8825.jpg"
                                    alt="简约生活牛仔风衬衫 牛仔色" />
                                </li>
                            </ul>
                            <div class="smallImgDown">
                                <img src="images/small/smallImgDown01.gif"
                                alt="" title="">
                            </div>
                        </div>
                        <div id="vertical" class="bigImg" style="float: right; display: inline;">
                            <img src="images/mid/0015137-1201101171649588073.jpg"
                            title="简约生活牛仔风衬衫" id="midimg">
                    ...
                    <div class="btnFangdaArea">
                        
                        <span style="width: 101px;">
                            <a class="btnSC" href="UserFavorite.html"
                            target="_blank">
                                收藏该商品
                            </a>
                        </span>
                ...
                <div class="danpinRight">
                    ...
                    <!-- E 价格区域 -->
                    <!-- S 选择区域 -->
                    <div class="selectArea" style="border: 1px solid #ccc">
                        <div class="selColorArea" style="background-color: #f4f7fc">
                            <div class="shoppingCarArea">
                                ...
                                <div class="goodsCar">
                                    <a href="shopping.html">
                                        <button class="btn1" id="addToShoppingCar">
                                        </button>
                                    </a>
									<a href="shopping_addr.html">
									 <button class="btn2" id="addToShoppingCar">
                                      </button>
									<!-- <img width="126" height="28" src="images/pic_gwc__r2_c10.jpg"/> -->
									</a>
                                </div>
                                <span class="blank10">
                                </span>
          ...
          <div class="sideBarSettabArea"></div>
        </div>
